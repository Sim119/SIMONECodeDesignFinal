...
function drawWave(n, rows) {
  ...
  endShape();
    ...
    noFill();
  stroke(color(10,25,250));
  strokeWeight(26);
arc(500, 550, 620, 620, PI + QUARTER_PI, TWO_PI);
arc(500, 550, 520, 520, PI, PI + QUARTER_PI);
arc(500, 550, 420, 420, 20, PI + QUARTER_PI);
line(600,750, 565, 650);
  line(550, 650, 590, 650);
  
  arc(500, 550, 520, 520, PI + QUARTER_PI, TWO_PI);
arc(500, 550, 220, 220, PI, PI + QUARTER_PI);
